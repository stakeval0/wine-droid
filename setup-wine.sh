...
function setup_wine() (
    ...
    cd /opt
    wget https://github.com/Kron4ek/Wine-Builds/releases/download/$1/wine-$1-amd64.tar.xz -q
    tar -xf wine-$1-amd64.tar.xz
    rm wine-$1-amd64.tar.xz
    mv wine-$1-amd64 wine$1
    cd /opt/wine$1/bin/
